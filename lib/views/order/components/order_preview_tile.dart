                      ...
                      child: Row(
                        ...
                        children: [
                          Opacity(
                            ...
                            child: Text(
                              'Confirmed',
                              style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: _orderColor()),
                            ),
                          ),
                          Opacity(
                          ...
                          Opacity(
                            opacity: status == OrderStatus.delivery || status == OrderStatus.cancelled ? 1 : 0,
                            child: Text(
                              status == OrderStatus.delivery ? 'Delivery' : 'Cancelled',
                              style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: _orderColor()),
                            ),
                          ),
                        ],
